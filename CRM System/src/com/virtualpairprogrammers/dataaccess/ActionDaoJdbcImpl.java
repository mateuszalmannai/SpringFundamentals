...
public class ActionDaoJdbcImpl implements ActionDao {
  ...
  private static final String CREATE_TABLE_SQL = "CREATE TABLE ACTION (ACTION_ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1), DETAILS VARCHAR(255), COMPLETE BOOLEAN, OWNING_USER VARCHAR(20), REQUIRED_BY DATE)";
  ...
  private void createTables() {
    try {
      ...
      System.err.println("Assuming the Action table already exists.");
    }
  }
